...
VALUES('mateusz@gmail.com',30.0,2,'ENTIRE_APARTMENT','Pretty Apartment in Plaza Mayor','Apartment in Sol is a cozy accommodation right in the center of Madrid, where on every corner there is fun due to the innumerable bars, restaurants, shops and markets in the area. The apartment has a kitchenette, free wifi in all areas, television, oven and microwave, washing machine, hair dryer, coffee maker and toaster. Sheets and towels are provided upon arrival.',1,'1','Plaza Mayor','Madrid','Spain','34',LOAD_FILE('/images/img1.jpg'));

INSERT INTO `airbnbdb`.`Apartment`
VALUES('mateusz@gmail.com',50.0,1,'ENTIRE_APARTMENT','Stunning Apartment in Sol','Apartment in Sol is a cozy accommodation right in the center of Madrid, where on every corner there is fun due to the innumerable bars, restaurants, shops and markets in the area. The apartment has a kitchenette, free wifi in all areas, television, oven and microwave, washing machine, hair dryer, coffee maker and toaster. Sheets and towels are provided upon arrival.',0,'2','Calle del Sol','Madrid','Spain','16',LOAD_FILE('/images/img1.jpg'));

INSERT INTO `airbnbdb`.`Apartment`
VALUES('dima@gmail.com',65.0,3,'ENTIRE_APARTMENT','Central and quiet','Apartment in Sol is a cozy accommodation right in the center of Madrid, where on every corner there is fun due to the innumerable bars, restaurants, shops and markets in the area. The apartment has a kitchenette, free wifi in all areas, television, oven and microwave, washing machine, hair dryer, coffee maker and toaster. Sheets and towels are provided upon arrival.',4,'15','Calle Central','Madrid','Spain','5',LOAD_FILE('/images/img3.jpg'));

INSERT INTO `airbnbdb`.`Apartment`
VALUES('piotrducki@gmail.com',80.0,1,'ENTIRE_APARTMENT','Flat in front of the Royal Palace','Apartment in Sol is a cozy accommodation right in the center of Madrid, where on every corner there is fun due to the innumerable bars, restaurants, shops and markets in the area. The apartment has a kitchenette, free wifi in all areas, television, oven and microwave, washing machine, hair dryer, coffee maker and toaster. Sheets and towels are provided upon arrival.',2,'2','Calle Royal','Madrid','Spain','1',LOAD_FILE('/images/img4.jpg'));

INSERT INTO `airbnbdb`.`Apartment`
VALUES('piotrszylar@gmail.com',70.0,2,'ENTIRE_APARTMENT','Apartment near Gran Via','Apartment in Sol is a cozy accommodation right in the center of Madrid, where on every corner there is fun due to the innumerable bars, restaurants, shops and markets in the area. The apartment has a kitchenette, free wifi in all areas, television, oven and microwave, washing machine, hair dryer, coffee maker and toaster. Sheets and towels are provided upon arrival.',2,'34','Gran Via','Madrid','Spain','2A',LOAD_FILE('/images/img5.jpg'));
